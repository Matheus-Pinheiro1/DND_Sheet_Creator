...
- Evite colocar regra de D&D direto em widgets grandes. Prefira mover calculos
  para `lib/data/services` ou helpers pequenos.
- Quando criar uma tela nova, deixe o arquivo com o nome da propria tela.
- Arquivos gerados (`build/`, `.dart_tool/`, caches e zips locais) nao devem ir
  para o Git.

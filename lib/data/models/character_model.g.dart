...
class CharacterModelAdapter extends TypeAdapter<CharacterModel> {
  ...
  CharacterModel read(BinaryReader reader) {
    ...
    return CharacterModel(
      ...
      alignment: fields[10] as String,
      level: fields[11] as int,
      experiencePoints: fields[12] as int,
      strength: fields[13] as int,
      dexterity: fields[14] as int,
      constitution: fields[15] as int,
      intelligence: fields[16] as int,
      wisdom: fields[17] as int,
      charisma: fields[18] as int,
      maxHP: fields[19] as int,
      currentHP: fields[20] as int,
      temporaryHP: fields[21] as int,
      armorClass: fields[22] as int,
      speed: fields[23] as int,
      initiative: fields[24] as int,
      hitDie: fields[25] as int,
      ...
      copper: fields[39] as int,
      silver: fields[40] as int,
      electrum: fields[41] as int,
      gold: fields[42] as int,
      platinum: fields[43] as int,
      inspiration: fields[44] as bool,
      deathSaveSuccesses: fields[45] as int,
      deathSaveFailures: fields[46] as int,
      ...
      exhaustionLevel: fields[57] as int,
    );
  }
